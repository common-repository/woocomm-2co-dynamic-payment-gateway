...
class TCO_Payment
{
    ...
    public function __construct() {
        $this->x_receipt_link_url = "http://" . $_SERVER['HTTP_HOST'] . "/response.php";
    }
    ...
    function submitPayment() {        
        echo showMessage('info', 'Passing sale to 2Checkout for Processing...');
        echo "<form id=\"tco_payment_submit_id\" style=\"display:none;\" class=\"tco_payment_submit\" name=\"form\" action=\"$this->purchase_url\" method=\"post\">\n";
